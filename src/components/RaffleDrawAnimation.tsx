...
export default function RaffleDrawAnimation({ 
  ...
  return (
    <div className="fixed inset-0 bg-maza-cream/95 backdrop-blur-sm z-[10000] flex items-center justify-center p-4">
      {/* Confetti Animation */}
      {showConfetti && (
        <Confetti
      ...
      <div className="relative w-full max-w-6xl md:max-w-7xl px-4 md:px-8">
        ...
        <div className="text-center mb-6 md:mb-10">
          <h2 className="text-3xl md:text-5xl font-black text-black mb-3 md:mb-4 uppercase">
          ...
          {Array.from({ length: 5 }).map((_, idx) => {
            ...
            return (
              <div
                ...
                className={`
                  relative p-4 md:p-6 rounded-lg border-2 transition-colors duration-300 shadow-neo
                  ${
                    isRevealed && winner
                      ? 'bg-maza-pink border-black scale-105'
              ...
              >
                {/* Winner Number Badge */}
                <div className="absolute -top-3 -left-3 md:-top-4 md:-left-4 w-8 h-8 md:w-10 md:h-10 rounded-lg bg-black flex items-center justify-center border-2 border-white z-10">
                  <span className="text-maza-cream font-black text-sm md:text-base">
                    {idx + 1}
                  </span>
                </div>
                    ...
                    <>
                      ...
                      {isRevealed && winner && (
                        <div className="space-y-2 animate-fade-in">
                          <div className="text-black font-black text-lg md:text-2xl">
                ...
                {isRevealed && winner && animationPhase !== "cycling" && (
                  <div className="absolute inset-0 rounded-lg bg-maza-cream/40 animate-ping opacity-40" />
                )}
              </div>
            );
          })}
        ...
        {animationPhase === "complete" && (
          <div className="text-center bg-white border-2 border-black rounded-lg p-4 md:p-6 shadow-neo">
            <p className="text-black text-lg md:text-2xl font-black mb-2 md:mb-3 uppercase">
